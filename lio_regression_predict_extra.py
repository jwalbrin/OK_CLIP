""" 
lio_regression_predict_extra.py
...
n_fold * (n_exemp * 20 extra objects) best_k_sizes * proxy_dims
(e.g. 80 * (10 * 20) * 7 * 3)
"""
import numpy as np
import os
...
save_data_object(
    extra_object, out_path + f"lio_object_{data_object.model_name}_extra.pkl"
)
