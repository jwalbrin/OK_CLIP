...
Note: n exemplar images = 10 exemplars (per each of the 80 objects)
"""
...
bkf_stem = "RFE_BestFeatures_%s_%s_%dComp.npz"
...
# Load best k features data; test this!!!
bkf_full_path = os.path.join(bkf_path, bkf_stem % (dnn_name, feat_name, 
                                                               n_comp))
